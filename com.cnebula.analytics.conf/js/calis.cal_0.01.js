...
//				此while循环在chrome中出现异常：Too much time spent in unload handler
//				参考：http://forums.thedailywtf.com/forums/p/24374/253985.aspx
				
				for( var i = 0; now.getTime() < expireDateTime; i++) 
				{ 
					now = new Date();
				}
			}
